...
//       <section className="relative bg-[url('https://img.freepik.com/free-photo/black-friday-sales-elements-assortment-with-copy-space_23-2148665617.jpg?semt=ais_hybrid&w=740')] h-[500px] my-auto bg-center bg-cover bg-no-repeat text-white">
//         <div className=" max-w-[1320px] mx-auto grid md:grid-cols-2 gap-8 items-center px-6 py-50">

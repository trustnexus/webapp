    ...
    <div className="w-full">
      ...
      <div className="h-[400px] relative text-white bg-[url('https://png.pngtree.com/background/20210714/original/pngtree-abstract-futuristic-communication-low-poly-dark-blue-vector-background-design-picture-image_1249984.jpg')] bg-no-repeat bg-cover bg-center flex pl-4 md:pl-[80px] items-center">
        <div className="banner flex flex-col absolute top-24 md:top-32 space-y-4">
          <p className="text-sm md:text-lg">Generative AI
</p>
...
Painting a vision <br />
of limitless innovation          </p>
...
The Generative AI uprising            </p>
            <p className="text-base md:text-lg">
            The technology at the core of generative AI is poised to revolutionize work and reshape the business landscape. It offers the potential for improved efficiency, cost savings, and increased customer satisfaction. Its predictive capabilities enhance decision-making and innovation.
            </p>
          </div>
          <div className="unified-image  flex-1 max-w-[648px] w-full">
            <img
              src="https://www.systemsltd.com/sites/default/files/2023-10/MicrosoftTeams-image-_318_-1.webp"
...
Revolutionizing industries, uplifting businesses with generative AI          </h1>
...
Next-level personalized experience and hyper-automation excellence
          </p>
          <Swiper
            modules={[Autoplay]}
            spaceBetween={20}
